...
const stages = [
  ...
  { name: "Build", detail: "Collaborate across product and engineering to make the workflow operable.", artifact: "Python and TypeScript products" },
  ...
  { name: "Launch", detail: "Plan rollout, safeguards, ownership, and feedback loops before wider use.", artifact: "Validation · Risk controls" },
  { name: "Measure", detail: "Instrument behavior, acceptance, rework, cost, latency, and user outcomes.", artifact: "Product analytics · Operational reporting" },
